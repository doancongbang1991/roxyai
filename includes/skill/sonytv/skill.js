...
let SONY_TV_IP = localStorage.getItem("SonyIP"); // updated from local storage
let SONY_TV_PRESHARED_KEY = localStorage.getItem("SonyPre");
...
COMMAND_MAP['louder'] = 'AAAAAQAAAAEAAAASAw==';
COMMAND_MAP['softer'] = 'AAAAAQAAAAEAAAATAw==';
COMMAND_MAP['mute'] = 'AAAAAQAAAAEAAAAUAw==';
COMMAND_MAP['wake on lan'] = 'AAAAAQAAAAEAAAAuAw==';
...
COMMAND_MAP['wake up'] = 'AAAAAQAAAAEAAAAvAw==';
